...
- Si el cambio afecta a **`docs.tech.architectureDocPath`** o **`docs.tech.styleBibleDocPath`** (si están configurados en `.claude/ms-context.json`) solo en valores de constantes o parámetros, es `fast`.
