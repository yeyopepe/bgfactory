...
**Out of scope:** la modal de solo lectura "Ver copias vinculadas..." (`ui/componentCopiesModal.js`) no incorpora ninguna acción de conversión por fila — se mantiene tal cual, sin cambios.
...
10. La incongruencia de documentación señalada por `pv-new` (pestaña "Copias" ausente en `05-ui-layer.md`/`01-component-model.md`) queda corregida en la actualización de documentación de este cambio.
