...
- Las filas "Exportar recursos (.zip)" y "Exportar hoja de producción (.csv)" aparecen en la maqueta visual dentro de este mismo desplegable, pero no están conectadas a ningún flujo real todavía (fuera de alcance de este cambio).
