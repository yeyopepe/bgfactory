...
## 2026-08-19 — initial session

en las propiedades "Visuales" de los dados, el orden debe ser:
- Sección Tamaño
- Sección Estilo  (nueva) y mete dentro el color del cuerpo, de los números y el tipo de fuente
- Sección Extrusión
