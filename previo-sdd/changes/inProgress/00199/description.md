...
Queda para el análisis técnico (`pv-how`) decidir, evaluando qué conviene para el mantenimiento futuro sin añadir complejidad innecesaria, si además del listado del mazo hay otros puntos del código que hoy también pintan la cara de una carta por su cuenta y deberían pasar a reutilizar esta misma vía.
...
- La decisión técnica concreta de cómo rasterizar el DOM de una cara (qué mecanismo, dónde vive el código reutilizable por tipo de elemento) queda pendiente de diseño en `pv-how`.
