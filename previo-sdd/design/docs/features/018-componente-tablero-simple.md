...
- **Color con patrón**: un color de fondo con una rejilla superpuesta. La rejilla puede ser cuadrada o de hexágonos (con orientación vertical u horizontal), con color, grosor de línea y número de filas y columnas configurables. Un tablero guardado con un valor de forma de patrón antiguo ("hexagonal", sin orientación) se dibuja como rejilla hexagonal, igual que la opción hexagonal actual.
...
- **Code**: 00019, 00063, 00068, 00089, 00136, 00153, 00154, 00156, 00158, 00251.
- **Since**: 2026-07-18
