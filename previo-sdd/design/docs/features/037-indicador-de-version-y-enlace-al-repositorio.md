...
- La segunda con un enlace al repositorio del proyecto en GitHub. El enlace se muestra con el texto `Ver en Github` y, al pulsarlo, abre el repositorio (`https://github.com/yeyopepe/bgfactory`) en una pestaña nueva del navegador, sin sacar al usuario de la aplicación.
