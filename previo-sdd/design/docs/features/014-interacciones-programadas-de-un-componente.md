...
La modal de configuración de un componente tiene una pestaña propia "Interacciones" (ver [Alta/edición/borrado de componentes con modal de tabs](002-alta-edicion-borrado-de-componentes-con-modal-de-tabs.md)), situada entre "Contenido" y "Copias", cuyo contenido es la sección "Interacciones programadas". Esa sección se muestra siempre (antes de existir el ajuste de click derecho descrito más abajo, solo aparecía si el tipo tenía alguna interacción de click izquierdo programada). Muestra un desplegable por cada interacción de click izquierdo que tenga el tipo, con las opciones "Ninguna" y el nombre de la interacción (esta última seleccionada por defecto). Un componente nuevo nace con todas sus interacciones activas.
