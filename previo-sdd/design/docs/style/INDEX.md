...
| `03-modales-menus.md` | Icono de ayuda, modales de error/éxito, cursores, etiquetas/insignias de componente, modales anchas, botón maximizar, checklist agrupado, secciones dentro de pestañas, menú desplegable de acciones, menú contextual, copiar/pegar estilo, grupo de botones icono-solo, título de cabecera editable, slider con marcas imantadas, icono ilustrativo por fila en "Añadir componente" |
