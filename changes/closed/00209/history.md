...
Botón de ver contenido del mazo un poco más abajo ahora se solapa con la sección imagen (parte del prompt combinado que dio pie a esta entrada, dentro de un `/ms-new` sobre la pestaña de propiedades específicas de los mazos).
