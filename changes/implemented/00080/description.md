...
- build_all.py -> versión completa de todo sin ofuscar (index-vXXXXX-all.html)
- build_game.py -> versión solo modo juego sin ofuscar (index-vXXXXX-game.html)
- build_distribute_all.py -> versión ofuscada de build.py (index-vXXXXX-all.obf.html)
- build_distribute_game.py -> versión ofuscada de build_game.py (index-vXXXXX-game.obf.html)

Las versiones:
- index-vXXXXX-all.html -> versión completa de todo sin ofuscar
- index-vXXXXX-game.html -> versión solo modo juego sin ofuscar
- index-vXXXXX-all.obf.html -> versión completa ofuscada a partir de index-vXXXXX.html
