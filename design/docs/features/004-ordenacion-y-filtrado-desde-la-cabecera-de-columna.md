...
Al pulsar sobre el nombre de cualquier columna de las tablas de los tres paneles flotantes de modo edición (Componentes, Recursos y Grupos) se abre un menú desplegable con:

- **Ordenar A..Z** / **Ordenar Z..A**: cada opción funciona como un interruptor — al pulsarla se activa (y queda marcada dentro del propio menú); si ya estaba activa y se vuelve a pulsar, se desactiva y la tabla vuelve a su orden por defecto (alfabético por nombre en Recursos y Grupos, por la columna "Orden" en Componentes). Cada tabla admite una única columna ordenada a la vez: activar la ordenación de una columna desactiva automáticamente la que estuviera activa en cualquier otra columna de esa misma tabla.
...
- **Disponible en**: modo edición — en los tres paneles flotantes (ver [Panel flotante de componentes](003-panel-flotante-de-componentes-con-seleccion-resaltado-arrastre-y-redimensionado.md), [Panel flotante de recursos](006-panel-flotante-de-recursos-con-filtro-de-texto.md) y [Grupos, organización de elementos por nombre](008-grupos-organizacion-de-elementos-por-nombre.md)).
- **Código**: 00165, 00172, 00173.
- **Desde**: 2026-08-06
