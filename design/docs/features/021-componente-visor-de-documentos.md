...
- **Disponible en**: renderizado sobre la mesa en modo juego y modo edición; alta eligiendo "Visor de documentos" en la modal previa de tipo al pulsar "+ Añadir componente" (ver [Alta/edición/borrado de componentes con modal de tabs](002-alta-edicion-borrado-de-componentes-con-modal-de-tabs.md)).
