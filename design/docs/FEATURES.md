...
- **Código**: 00002, 00003, 00004, 00013, 00015, 00018, 00019, 00020, 00029.
...
- **Disponible en**: modo edición (arrastre y redimensionado siempre disponibles); modo juego (arrastre solo para los componentes con "Bloqueado" desmarcado, lo que incluye siempre a "Ficha" salvo que se marque a mano). La posición y el tamaño resultantes se reflejan en ambos modos; el cursor de dedo en elementos pulsables, en toda la app.
- **Código**: 00006, 00009, 00015, 00018, 00019, 00020, 00029, 00031.
...
Cualquier componente de la mesa (cuadro de texto, tablero, dado, visor de documentos o ficha) puede mostrar su tipo y su identificador al pasar el ratón por encima, sin necesidad de abrirlo, con el formato "Tipo: id".
