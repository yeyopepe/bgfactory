...
const ICONS = {
  ...
  // Cabeceras de paneles flotantes
  'panel-componentes': '<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/>',
  'panel-recursos': '<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',
  ...
  // Conjuntos pre-definidos del picker (00236)
  'preset-french-deck': '<rect width="14" height="18" x="8" y="3" rx="2"/><rect width="14" height="18" x="4" y="5" rx="2"/><path d="M11 10c1.2 1.3 2.4 2.2 2.4 3.5a1.3 1.3 0 0 1-2.1 1 1.3 1.3 0 0 1-2.1-1c0-1.3 1.2-2.2 1.8-3.5z" fill="currentColor" stroke="none"/>',
  ...
  'tab-visual': '<path d="M18.37 2.63 14 7l-1.59-1.59a2 2 0 0 0-2.82 0L8 7l9 9 1.59-1.59a2 2 0 0 0 0-2.82L17 10l4.37-4.37a2.12 2.12 0 1 0-3-3Z"/><path d="M9 8c-2 3-4 3.5-7 4l8 10c2-1 6-5 6-7"/><path d="M14.5 17.5 4.5 15"/>',
  'tab-interacciones': '<path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/>',
};
