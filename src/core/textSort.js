...
// los paneles flotantes de modo edición: numérico si ambos valores son
// `number`, si no comparación de texto insensible a mayúsculas/tildes (mismo
// criterio que sortByName) y consciente de números dentro del texto
