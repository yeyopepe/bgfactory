...
// vendor/marked.js (CommonMark + GFM completo) — cambio 00040. El HTML
// resultante sigue pasando por sanitizeHtml.js antes de insertarse en el DOM
// (marked no sanitiza su salida).
